...
import { API_AREA_GET_BY_ID, API_BASE_URL, API_CITY_GET_BY_ID, API_CUSTOMERS_GET_BY_ID, API_PINCODE_GET_BY_ID, API_SUBSCRIPTION_OFFER_APPLY, GET_ECOMMERCE_WALLET_DETAILS } from "customhooks/All_Api/Apis";
...
const CheckoutTrail = () => {
  ...
  console.log("cartData in trail page", cartData);
                  ...
                  <div className="input-fields-container">
                    <div className="input-fields">
                      ...
                      >
                        ...
                        {cityData &&
                          cityData.map((eachItem) => (
                            <option
                              value={`${eachItem.id} ${eachItem.city}`}
                              key={eachItem.id}
                            >
                              {eachItem.city}
                            </option>
                    ...
                    <div className="input-fields">
                      ...
                      >
                        ...
                        {finalFilteredDropdownPincodeValues &&
                          finalFilteredDropdownPincodeValues.map((eachItem) =>
                            eachItem.map((code, index) => (
                  ...
                  <div className="input-fields-container">
                    <div className="input-fields">
                      ...
                      >
                        ...
                        {finalFilteredDropdownAreaValues &&
                          finalFilteredDropdownAreaValues.map((eachItem) =>
                            eachItem.map((area, index) => (
                              <option key={index} value={area.id}>
                                {area.area}
                              </option>
                  ...
                  <div key={cartItem.id}>
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <div>
                        ...
                        >
                          ₹ {cartItem.product.product_rate}.00
                        </h6>
                      </div>
                    </div>
                    <hr className="horizontal-rule" />
