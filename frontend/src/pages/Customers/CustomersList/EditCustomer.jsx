...
import {
  ...
  API_CUSTOMERS_UPDATE_GET_BY_ID_AND_POST,
...
const EditCustomer = () => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      child: customer?.child !== null && customer?.child !== undefined ? customer.child : 0,
      adult: customer?.adult !== null && customer?.adult !== undefined ? customer.adult : 0,
      senior_citizen: customer?.senior_citizen !== null && customer?.senior_citizen !== undefined ? customer.senior_citizen : 0,
      registered_on: customer?.registered_on || "",
      customer_group_id: customer?.customer_group_id || "",
      // city_id: addresses?.[0]?.city_id || "",
      city_id: addresses?.[0]?.city || "",
      pincode: addresses?.[0]?.pincode_id || "",
      area: addresses?.[0]?.area_id || "",
      house_no: addresses?.[0]?.house_no || "",
      society: addresses?.[0]?.society || "",
    ...
    validationSchema: Yup.object({
      ...
      // grace_limit: Yup.string().matches(
      //   /^[0-9]+$/,
  ...
  console.log(validation.values.pincode);
  ...
  //   Customer List Data Fetch by id End
  ...
  <FormGroup className="mb-3">
    ...
    <Input
      ...
      onChange={validation.handleChange}
      onBlur={validation.handleBlur}
      value={validation.values.child === 0 ? "0" : validation.values.child || ""}
      invalid={validation.touched.child && !!validation.errors.child}
    />
    {validation.touched.child && validation.errors.child && (
      <FormFeedback type="invalid">
...
<Col md="3">
  <FormGroup className="mb-3">
    ...
    <Input
      ...
      onChange={validation.handleChange}
      onBlur={validation.handleBlur}
      value={validation.values.adult === 0 ? "0" : validation.values.adult || ""}
      invalid={validation.touched.adult && !!validation.errors.adult}
    />
    {validation.touched.adult && validation.errors.adult && (
      <FormFeedback type="invalid">
...
<Col md="3">
  <FormGroup className="mb-3">
    ...
    <Input
      ...
      onChange={validation.handleChange}
      onBlur={validation.handleBlur}
      value={validation.values.senior_citizen === 0 ? "0" : validation.values.senior_citizen || ""}
      invalid={validation.touched.senior_citizen && !!validation.errors.senior_citizen}
    />
    {validation.touched.senior_citizen && validation.errors.senior_citizen && (
      <FormFeedback type="invalid">
                      ...
                      <Col md="4">
                        <FormGroup className="mb-3">
                          ...
                          >
                            ...
                            {pincodeAllData
                              .find(
                                (items) => items.id == addresses?.[0]?.city
                              )
                              ?.pincodes.map((item) => (
                                <option key={item.id} value={item.id}>
                                  {item.code}
                      ...
                      <Col md="4">
                        <FormGroup className="mb-3">
                          ...
                          >
                            ...
                            {AllData.find(
                              (item) =>
                                item.pincode_id == addresses?.[0]?.pincode_id
                            )?.areas.map((items) => (
